...
/** A predefined conversion archetype the player can pick when converting a fully conditioned captive */
export interface ConversionArchetype {
    ...
    personalityRewrite: string;      // New personality description that replaces the hero's
    grantedTraits: string[];         // 1-2 traits added by the conversion
    llmConversionDirective: string;  // Instructions for the final conversion scene LLM prompt
}

/** The predefined list of conversion archetypes */
