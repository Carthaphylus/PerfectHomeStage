...
export const BREW_RECIPE_REGISTRY: Record<string, BrewRecipe> = {
    ...
    devotion_draught: {
        id: 'devotion_draught',
        name: 'Devotion Draught',
        resultItemName: 'Devotion Draught',
        elementThresholds: { light: 4, water: 4 },
        minimumTotal: 10,
        dominantElement: 'light',
        allowedForms: ['potion', 'tincture'],
        discoveryHint: 'Radiant light flowing through deep water. A draught of adoration...',
    },
    mana_restorative: {
        id: 'mana_restorative',
        name: 'Mana Restorative',
        resultItemName: 'Mana Restorative',
        elementThresholds: { light: 4, fire: 3 },
        minimumTotal: 9,
        dominantElement: 'light',
        allowedForms: ['potion', 'tincture'],
        discoveryHint: 'Bright light fueled by fire. The arcane replenished...',
    },
    ironhide_tonic: {
        id: 'ironhide_tonic',
        name: 'Ironhide Tonic',
        resultItemName: 'Ironhide Tonic',
        elementThresholds: { earth: 5, water: 2, fire: 1 },
        minimumTotal: 10,
        dominantElement: 'earth',
        allowedForms: ['potion', 'salve'],
        discoveryHint: 'Dense earth anchored by water and a spark. Unyielding...',
    },
    shadow_veil: {
        id: 'shadow_veil',
        name: 'Shadow Veil',
        resultItemName: 'Shadow Veil',
        elementThresholds: { shadow: 4, earth: 2 },
        minimumTotal: 8,
        dominantElement: 'shadow',
        allowedForms: ['incense', 'tincture'],
        discoveryHint: 'Shadow grounded in earth. A cloak of darkness...',
    },
    ember_salve: {
        id: 'ember_salve',
        name: 'Ember Salve',
        resultItemName: 'Ember Salve',
        elementThresholds: { fire: 4, earth: 3 },
        minimumTotal: 9,
        dominantElement: 'fire',
        allowedForms: ['salve'],
        discoveryHint: 'Fire tempered by earth. Burns without burning...',
    },
    tranquil_mist: {
        id: 'tranquil_mist',
        name: 'Tranquil Mist',
        resultItemName: 'Tranquil Mist',
        elementThresholds: { water: 4, light: 3 },
        minimumTotal: 9,
        dominantElement: 'water',
        allowedForms: ['incense'],
        discoveryHint: 'Water carried by light. Peace made visible...',
    },
    soulbind_tincture: {
        id: 'soulbind_tincture',
        name: 'Soulbind Tincture',
        resultItemName: 'Soulbind Tincture',
        elementThresholds: { shadow: 5, fire: 3 },
        minimumTotal: 11,
        dominantElement: 'shadow',
        allowedForms: ['tincture'],
        discoveryHint: 'Deep shadow ignited by fire. Binds the very soul...',
        soulFragmentCost: 1,
    },
};
