...
export const CONDITIONING_ACTIONS: Record<string, ConditioningAction> = {
    ...
    lullaby_whisper: {
        ...
        icon: 'music',
        tooltip: 'An enchanted hum that dulls awareness.',
    ...
    spiral_pendant: {
        ...
        icon: 'orbit',
        tooltip: 'Swing the Hypnotic Pendant — its golden spiral ensnares the gaze.',
        category: 'enchantment',
    ...
    mind_haze: {
        ...
        label: 'Mind Haze',
        icon: 'cloud',
        tooltip: 'An enchanted music box clouds their thoughts.',
        category: 'enchantment',
        brainwashingDelta: 2,
        failDelta: 0,
        manaCost: 3,
    ...
    vexing_glare: {
        ...
        label: 'Vexing Glare',
        icon: 'eye',
        tooltip: 'A piercing stare laced with dark magic.',
        category: 'hex',
    ...
    dread_whisper: {
        ...
        label: 'Dread Whisper',
        icon: 'wind',
        tooltip: 'Breathe words of creeping dread into their ear.',
        category: 'hex',
        brainwashingDelta: 1,
        failDelta: 0,
        manaCost: 2,
    ...
    shadow_grasp: {
        ...
        label: 'Shadow Grasp',
        icon: 'hand',
        tooltip: 'Tendrils of shadow coil around the captive.',
        category: 'binding',
        brainwashingDelta: 1,
        failDelta: 0,
        manaCost: 2,
    ...
    ember_incense: {
        ...
        label: 'Ember Incense',
        icon: 'flame',
        tooltip: 'Burn enchanted incense — golden smoke clouds the mind.',
        category: 'alchemy',
    ...
    submission_elixir: {
        ...
        icon: 'flask',
        tooltip: 'Force a potent elixir down their throat. Guaranteed progress.',
        category: 'alchemy',
    ...
    soothing_aura: {
        ...
        label: 'Soothing Aura',
        icon: 'sun',
        tooltip: 'Project an aura of warmth and false safety.',
        category: 'beguile',
        brainwashingDelta: 1,
        failDelta: 0,
        manaCost: 2,
    ...
    // ═══════════════════════════════════════
    //  LESSER SPELLS — Moderate Mana Cost
    // ═══════════════════════════════════════
    ...
    arcane_visor: {
        ...
        label: 'Arcane Visor',
        icon: 'zap',
        tooltip: 'Project the golden spiral directly into their vision.',
        category: 'enchantment',
    ...
    whisper_command: {
        ...
        icon: 'wand',
        tooltip: 'Plant a compulsion directly in their weakened mind.',
        category: 'enchantment',
    ...
    mirror_of_doubt: {
        ...
        icon: 'scan-eye',
        tooltip: 'An enchanted mirror shows them a willing version of themselves.',
        category: 'enchantment',
    ...
    isolation_hex: {
        ...
        label: 'Isolation Hex',
        icon: 'ghost',
        tooltip: 'A curse that magnifies loneliness and despair.',
        category: 'hex',
        skillCheck: { skill: 'charm', difficulty: 40 },
        brainwashingDelta: 4,
        failDelta: 0,
    ...
    silver_tongue: {
        ...
        label: 'Silver Tongue',
        icon: 'message-circle',
        tooltip: 'Twist their own words into weapons against them.',
        category: 'hex',
        skillCheck: { skill: 'charm', difficulty: 45 },
        brainwashingDelta: 4,
        failDelta: 0,
    ...
    phantom_chains: {
        ...
        icon: 'link',
        tooltip: 'Spectral chains that tighten with every attempt to resist.',
        category: 'binding',
        brainwashingDelta: 3,
        failDelta: 0,
        manaCost: 6,
    ...
    numbing_salve: {
        ...
        label: 'Numbing Salve',
        icon: 'droplets',
        tooltip: 'An alchemical salve that dulls resistance on contact.',
        category: 'alchemy',
        brainwashingDelta: 3,
        failDelta: 0,
        manaCost: 6,
    ...
    feather_touch: {
        ...
        label: 'Feather Touch',
        icon: 'feather',
        tooltip: 'A tender, disarming caress that confuses the senses.',
        category: 'beguile',
        brainwashingDelta: 2,
        failDelta: 0,
        manaCost: 5,
    ...
    deep_trance: {
        ...
        label: 'Deep Trance',
        icon: 'waves',
        tooltip: 'Plunge them into a full hypnotic trance.',
        category: 'enchantment',
    ...
    eye_of_dominion: {
        ...
        icon: 'eye',
        tooltip: 'Lock eyes and project raw arcane will.',
        category: 'enchantment',
    ...
    trigger_rune: {
        ...
        label: 'Trigger Rune',
        icon: 'sparkles',
        tooltip: 'Inscribe a command rune that fires on a trigger word.',
        category: 'enchantment',
    ...
    promise_of_freedom: {
        ...
        icon: 'star',
        tooltip: 'Dangle the illusion of escape — but the price is surrender.',
        category: 'hex',
    ...
    iron_embrace: {
        ...
        label: 'Iron Embrace',
        icon: 'shield',
        tooltip: 'Magical restraints that pulse with warmth, making captivity feel safe.',
        category: 'binding',
        brainwashingDelta: 4,
        failDelta: 0,
        manaCost: 12,
    ...
    torpor_draught: {
        ...
        icon: 'test-tubes',
        tooltip: 'A powerful sedative brew that dissolves willpower.',
        category: 'alchemy',
        brainwashingDelta: 5,
        failDelta: 0,
        manaCost: 14,
    ...
    gilded_cage: {
        ...
        label: 'Gilded Cage',
        icon: 'gem',
        tooltip: 'Show them visions of a comfortable life in service.',
        category: 'beguile',
        brainwashingDelta: 4,
        failDelta: 0,
        manaCost: 12,
    ...
    ambrosia: {
        ...
        label: 'Ambrosia',
        icon: 'heart',
        tooltip: 'Enchanted fruit that floods the body with euphoria.',
        category: 'beguile',
        brainwashingDelta: 3,
        failDelta: 0,
        manaCost: 10,
    ...
    // ═══════════════════════════════════════
    //  MASTER SPELLS — Maximum Mana Cost
    // ═══════════════════════════════════════
    ...
    soul_siphon: {
        ...
        label: 'Soul Siphon',
        icon: 'sparkles',
        tooltip: 'Extract a shard of memory and identity.',
        category: 'enchantment',
    ...
    ego_dissolution: {
        ...
        icon: 'brain',
        tooltip: 'Shatter their sense of self with overwhelming enchantment.',
        category: 'enchantment',
    ...
    total_dominion: {
        ...
        icon: 'crown',
        tooltip: 'Command absolute submission with overwhelming arcane force.',
        category: 'enchantment',
    ...
    identity_erasure: {
        ...
        icon: 'skull',
        tooltip: 'A devastating hex that erases who they were.',
        category: 'hex',
        skillCheck: { skill: 'power', difficulty: 65 },
        brainwashingDelta: 12,
        failDelta: 2,
    ...
    domination_sigil: {
        ...
        icon: 'flame',
        tooltip: 'Brand a permanent mark of magical ownership on their skin.',
        category: 'binding',
        brainwashingDelta: 8,
        failDelta: 0,
        manaCost: 25,
    ...
    oblivion_elixir: {
        ...
        icon: 'flask',
        tooltip: 'A perfected elixir that erases specific memories and resistance.',
        category: 'alchemy',
        consumeItem: 'Obedience Elixir',
    ...
    collar_of_devotion: {
        ...
        icon: 'circle-dot',
        tooltip: 'Fasten a Servant Collar — the ultimate mark of belonging.',
        category: 'beguile',
    ...
    pleasure_bond: {
        ...
        label: 'Pleasure Bond',
        icon: 'heart',
        tooltip: 'Weave enchantment linking obedience with ecstasy.',
        category: 'beguile',
    ...
    gaslight: {
        ...
        icon: 'skull',
        tooltip: 'Reframe their reality — make them question their own memories.',
        category: 'hex',
        skillCheck: { skill: 'wisdom', difficulty: 50 },
        brainwashingDelta: 6,
        failDelta: 0,
    ...
    false_comfort: {
        ...
        label: 'False Comfort',
        icon: 'moon',
        tooltip: 'Calculated warmth and understanding — a trap disguised as kindness.',
        category: 'beguile',
        skillCheck: { skill: 'charm', difficulty: 45 },
        brainwashingDelta: 5,
        failDelta: 0,
    ...
    sensory_flood: {
        ...
        label: 'Sensory Flood',
        icon: 'zap',
        tooltip: 'Blast every sense at once with enchanted crystals.',
        category: 'enchantment',
        skillCheck: { skill: 'charm', difficulty: 50 },
        brainwashingDelta: 8,
        failDelta: 1,
    ...
    binding_chant: {
        ...
        label: 'Binding Chant',
        icon: 'link',
        tooltip: 'Complete a circuit of the binding circle while chanting.',
        category: 'binding',
        skillCheck: { skill: 'power', difficulty: 50 },
        brainwashingDelta: 9,
        failDelta: 1,
