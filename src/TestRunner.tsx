        ...
        await stage.setState({
            ...
            heroes: {
                'Sable': {
                    ...
                    details: { 'Species': 'Tabby Cat', 'Class': 'Thief', 'Specialty': 'Stealth & Lockpicking', 'Weakness': 'Overconfidence', 'Quirk': 'Flicks her tail when lying' },
                ...
                'Veridian': {
                    ...
                    details: { 'Species': 'Deer', 'Class': 'Cleric', 'Specialty': 'Healing & Warding', 'Weakness': 'Trusts too easily', 'Quirk': 'Ears twitch when sensing danger' },
                ...
                'Kova': {
                    ...
                    details: { 'Species': 'Wolf', 'Class': 'Barbarian', 'Specialty': 'Raw Strength', 'Weakness': 'Easily provoked', 'Quirk': 'Howls at the moon involuntarily' },
                    location: 'Town',
                },
            },
            servants: {
                'Felicity': {
                    ...
                    details: { 'Species': 'Pink Cat', 'Former Role': 'Handmaiden', 'Specialty': 'Household Management', 'Loyalty': 'Absolute', 'Quirk': 'Hums while she cleans' },
                    loyalty: 100,
                ...
                'Locke': {
                    ...
                    details: { 'Species': 'Gray Fox', 'Former Role': 'Butler', 'Specialty': 'Security & Logistics', 'Loyalty': 'Unwavering', 'Quirk': 'Polishes silverware when thinking' },
                    loyalty: 85,
